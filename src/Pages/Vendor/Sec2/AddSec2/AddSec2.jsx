...
const AddSec2 = ({ baseURL }) => {
    ...
    let add_URL = `${baseURL}Addsection2`;
        ...
        <>
            <Container fluid>
                <div className="app__addprodects">
                    <Component.SubNav sub__nav={[{ name: "Section2", path: '/section2' }, { name: "Add Item", path: '/section2/add' }]} />
